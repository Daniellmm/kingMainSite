...
const Insurance = () => {
  ...
  return (
    <>
      <section className="relative flex min-h-[70vh] items-center justify-center overflow-hidden rounded-bl-[34px] rounded-br-[34px] bg-black px-10 pb-8 pt-12 md:min-h-0 md:rounded-bl-[100px] md:rounded-br-[100px] md:pb-16 md:pt-16">
        {/* <div className="flex flex-col items-center justify-center pt-10 md:flex-row-reverse"> */}
        <div className="relative z-10 flex w-full flex-col items-center justify-center pt-4 md:max-w-[800px] md:flex-row-reverse md:gap-8 md:pl-4 md:pr-4 md:pt-12 lg:max-w-[1800px]">
          ...
          <div className="flex flex-col items-center md:w-full md:flex-1 md:items-start md:self-start lg:w-1/2 xl:flex-none">
            <ScrollAnimation animation="zoomIn" delay={0.5}>
              <div className="pb-2 pt-4">
                <h1
                  className="py-0 text-center text-lg font-bold leading-tight text-white md:px-4 md:text-left md:text-xl lg:text-3xl xl:text-4xl"
            ...
            <ScrollAnimation animation="zoomIn" delay={0.5} className="grow-1">
              <div className="flex justify-center">
                <p
                  className="px-5 pb-4 text-center text-[10px] uppercase text-white md:pt-0 md:text-left md:text-[14px] lg:pt-4 xl:text-[16px]"
                  style={{ fontFamily: 'Montserrat, sans-serif' }}
                >
